            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <p class="mb-6 text-sm text-gray-600">
                        Pengaturan ini adalah <strong>Asumsi Global</strong> yang berlaku untuk semua proyek dalam perhitungan otomatis.
                    </p>
                    ...
                    <form action="{{ route('settings.update') }}" method="POST">
                        ...
                        <div class="space-y-4">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Suku Bunga per tahun (%)</label>
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Suku Bunga per bulan (%)</label>
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Pemodalan: Loan (%)</label>
                                    <input type="number" step="0.01" name="pemodalan_loan" value="{{ old('pemodalan_loan', round($settings['pemodalan_loan'], 2)) }}"
                                           class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Provisi (%)</label>
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">PPH pasal 23 (%)</label>
                                    <input type="number" step="0.01" name="pph_rate" value="{{ old('pph_rate', round($settings['pph_rate'], 2)) }}"
                                           class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>

                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Threshold Kelayakan (%)</label>
